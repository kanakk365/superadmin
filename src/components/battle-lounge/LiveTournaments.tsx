...
export function LiveTournaments() {
    const totalViewers = liveTournaments.reduce((acc, t) => acc + t.viewers, 0);
    const totalPlayers = liveTournaments.reduce((acc, t) => acc + t.players, 0);
                ...
                {liveTournaments.map((tournament) => (
                    ...
                    >
                        ...
                        <div className="absolute top-4 right-4 flex items-center gap-1.5 px-2 py-1 rounded-full bg-fuchsia-500/10 border border-fuchsia-500/20">
                            ...
                            <span className="text-xs font-semibold text-fuchsia-500">LIVE</span>
                        </div>

                        <div className="flex flex-col gap-4">
                            {/* Tournament Name & Game */}
                            <div>
                                <h4 className="text-lg font-semibold text-foreground group-hover:text-purple-500 transition-colors pr-16">
                                    {tournament.name}
                                </h4>
