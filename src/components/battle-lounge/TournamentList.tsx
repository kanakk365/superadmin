                ...
                <td className="px-6 py-3 text-sm font-normal text-foreground">
                  <span
                    className={cn(
                      ...
                      t.status === "Live Now" && "bg-cyan-100 text-cyan-800 dark:bg-cyan-900/30 dark:text-cyan-400",
                      t.status === "Registration Open" && "bg-sky-100 text-sky-800 dark:bg-sky-900/30 dark:text-sky-400",
                      t.status === "Coming Soon" && "bg-slate-100 text-slate-800 dark:bg-slate-800 dark:text-slate-400",
